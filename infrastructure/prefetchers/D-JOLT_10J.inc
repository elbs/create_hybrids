...
static constexpr size_t SignatureBits = 23; // Note: if you change this, you may need to re-tune the hash function in siggens.
                                            // Elba, used in G3, G4, G6, G7

#define LongRangePrefetcherSiggen Siggen_FifoRetCnt<7>      // Elba - E2
static constexpr size_t LongRangePrefetcherDistance = 15;   // Elba - E3
static constexpr size_t LongRangePrefetcher_N_Sets = 256 ;  // Elba - E4 (CONFIGURATION J; CHANGED: 2048 -> 256)
static constexpr size_t LongRangePrefetcher_N_Ways = 2;     // Elba - D4 (CONFIGURATION J; CHANGED: 4 -> 2)
static constexpr size_t LongRangePrefetcher_N_Vectors = 2;  // Elba - In G4
static constexpr size_t LongRangePrefetcher_VectorSize = 8; // Elba - In G4
static constexpr size_t LongRangePrefetcher_TagBits = 12;   // Elba - In G4, same as (23-11)
// -------------------------------------
//  miss table of long-range prefetcher
// -------------------------------------
// TODO Elba: 2048 Sets -> 512 Sets
...
//   head pointer :                  3 bits   // Elba - In H2
//   return counter :               32 bits   // Elba - In H2
//                           Total 259 bits
...
//   head pointer :                     4 bits  // Elba - H3
//                              Total 349 bits

#define ShortRangePrefetcherSiggen Siggen_FifoRetCnt<4>       // Elba - E5
static constexpr size_t ShortRangePrefetcherDistance = 4;     // Elba - E6
static constexpr size_t ShortRangePrefetcher_N_Sets = 128;    // Elba - E7 (CONFIGURATION J; CHANGED: 1024 -> 128)
static constexpr size_t ShortRangePrefetcher_N_Ways = 2;      // Elba - D7 (CONFIGURATION J; CHANGED: 4 -> 2)
static constexpr size_t ShortRangePrefetcher_N_Vectors = 2;   // Elba - In G7 
static constexpr size_t ShortRangePrefetcher_VectorSize = 8;  // Elba - In G7 
static constexpr size_t ShortRangePrefetcher_TagBits = 13;    // Elba - In G7, same as (23-10)
// --------------------------------------
//  miss table of short-range prefetcher
// --------------------------------------
// TODO Elba: 1024 Sets -> 256 Sets
...
//     bit vector               :  8bits
//  lru bit :                     2bits X 4096 entry =   8192 bits // Elba - In G7
//                                               Total 315392 bits
...
//   head pointer :                  2 bits   // Elba - In H5
//   return counter :               32 bits   // Elba - In H5
//                           Total 162 bits
...
//   head pointer :                   2 bits            // Elba - H6
//                             Total 94 bits

static constexpr size_t ExtraMissTable_N_Sets = 32;     // Elba - E8 (CONFIGURATION J; CHANGED: 256 -> 32)
static constexpr size_t ExtraMissTable_N_Ways = 2;      // Elba - D8 (CONFIGURATION J; CHANGED: 4 -> 2)
static constexpr size_t ExtraMissTable_N_Vectors = 2;   // Elba - In G8
static constexpr size_t ExtraMissTable_VectorSize = 8;  // Elba - In G8
static constexpr size_t ExtraMissTable_TagBits = 15;    // Elba - In G8, same as (23-8)
// ---------------------
//  extra miss table
// ---------------------
// TODO Elba: 256 Sets -> 64 Sets
...
class UpperBitTable {
    ...
    std::array<Entry, (1ull << UpperBitPtrBits) - 1> table = {}; // Elba: 31 entries set here, E11
public:
...
class WindowBasedStreamPrefetcher {
    ...
    static constexpr size_t TrainingTableSize = 16;   // Elba - E9
    static constexpr size_t MonitoringTableSize = 16; // Elba - E10   
...
void D_JOLT_PREFETCHER::branch_operate(uint64_t ip, uint8_t branch_type, uint64_t branch_target) {
    ...
    //std::cout << "sig_1: " << sig_1 << ", MissTagBits*MissTableSets: " << (1ull<<ExtraMissTable_TagBits) * ExtraMissTable_N_Sets << std::endl;
    //assert(sig_1 < (1ull<<ExtraMissTable_TagBits) * ExtraMissTable_N_Sets);
    //std::cout << "sig_2: " << sig_2 << ", MissTagBits*MissTableSets: " << (1ull<<ExtraMissTable_TagBits) * ExtraMissTable_N_Sets << std::endl;
    //assert(sig_2 < (1ull<<ExtraMissTable_TagBits) * ExtraMissTable_N_Sets);
    //std::cout << "sig_1: " << sig_1 << ", SRTagBits*SRPrefSets: " << (1ull<<ShortRangePrefetcher_TagBits) * ShortRangePrefetcher_N_Sets << std::endl;
    //assert(sig_1 < (1ull<<ShortRangePrefetcher_TagBits) * ShortRangePrefetcher_N_Sets);
    //std::cout << "sig_2: " << sig_2 << ", LRTagBits*LRPrefSets: " << (1ull<<LongRangePrefetcher_TagBits) * LongRangePrefetcher_N_Sets << std::endl;
